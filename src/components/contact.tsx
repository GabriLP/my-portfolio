...
const ContactForm: React.FC = () => {
  ...
  return (
    <section id='contact' className='p-[4%] bg-background'>
      ...
      <form ref={form} onSubmit={sendEmail} className="md:w-2/3 space-y-4 bg-background border border-border p-6 rounded-md shadow-md">
        ...
        <div className="flex justify-end">
          <button className="font-semibold mt-4 w-15 px-4 py-2 bg-primary hover:bg-secondary text-foreground rounded-md transition duration-300" type="submit">Send</button>
        </div>
      </form>
    </section>
  );
